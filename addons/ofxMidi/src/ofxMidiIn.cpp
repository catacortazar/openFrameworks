...
// ROGER
// --------------------------------------------------------------------------------------
// Find a device that I like
int ofxMidiIn::findMyDevicePort(){
	int p;
	if ( (p = this->findPortByName("nanoKONTROL")) >= 0)
		return p;
	else if ( (p = this->findPortByName("nanoPAD")) >= 0)
		return p;
	else if ( (p = this->findPortByName("nanoKEY")) >= 0)
		return p;
	else if ( (p = this->findPortByName("KONTROL")) >= 0)
		return p;
	// Default port: First
	else
	{
