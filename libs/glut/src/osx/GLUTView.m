...
// ROGER
#define SHARED_CONTEXTS
NSOpenGLContext *__mainContext = nil;
...
#ifdef SHARED_CONTEXTS
	   //NSLog(@"SHARED_CONTEXT ... [%d]\n",(int)__mainContext);
	   _openGLContext = [[NSOpenGLContext alloc] initWithFormat:pixelFormat shareContext:__mainContext];
	   if (__mainContext == nil)
		   __mainContext = _openGLContext;
#else
